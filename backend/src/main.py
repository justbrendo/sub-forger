...
def get_format_path(download_folder, media, format):
    return download_folder + "/" + media + "." + format
...
def main():
    ...
    video_file_path = get_format_path(
        download_folder=download_folder, media="video", format="mp4"
    )
    wav_path = get_format_path(
        download_folder=download_folder, media="audio", format="wav"
    )
    srt_path = get_format_path(
        download_folder=download_folder, media="subs", format="srt"
    )
    output_video_path = get_format_path(
        download_folder=download_folder, media="burned_video", format="mp4"
    )
